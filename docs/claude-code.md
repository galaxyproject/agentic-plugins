...
[Getting a Galaxy API key](galaxy-api-key.md)); a key typed literally on the
...
[Getting a Galaxy API key](galaxy-api-key.md)); typing it literally here stores
